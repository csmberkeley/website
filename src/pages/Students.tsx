                ...
                <div className="container">
                    <div className="section">
                        <div className="col l8 offset-l2 s10 offset-s1">
                            <h5 className="label">{ Labels.SECTIONS.SUPPORT.LABEL }</h5>
                            <p className="info">
                    ...
                    <div className="section">
                        <h5 className="label">{ Labels.SECTIONS.EXPECTATIONS.LABEL }</h5>
                        { Labels.SECTIONS.EXPECTATIONS.BODY_JSX }
                    </div>
                    <div className="divider"></div>
                    <div className="section">
                        <h5 className="label">{ Labels.SECTIONS.APPLICATION.LABEL }</h5>
