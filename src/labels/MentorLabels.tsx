...
export const SUBTITLE = "Gain experience tutoring a small group of students in the introductory " +
...
export const SECTIONS = {
    RESPONSIBILITIES: {
        ...
        BODY_JSX: (
            <span>
                ...
                <p className="info">
                    <b>Junior Mentors</b> are under the wing of a pair of <b>Senior Mentors</b> who
                    meet with them and a group of 4-5 other Junior Mentors once a week.
                </p>
                <p className="info">
                    <b>Senior Mentors</b> run these meetings, going over guidance on the week’s
                    material, teaching tips, etc.
                </p>
            </span>
        )
    },
    APPLICATIONS_OPEN: {
        ...
        BODY_JSX: (
            <span>
                <p className="info">
                    We are currently recruiting mentors for { COURSE_STRING_WITH_AND } (newly added!).
                    <br />
                    The{" "}
                    <Link to="/apply">
                        Junior Mentor and Associate Mentor application is available now!
                    </Link>{" "}
                    ...
                    . More information is in the application, and no late applications will be accepted.
                </p>
                <p className="info">
                    We are not opening Senior Mentor positions at this time. We look forward to
    ...
    APPLICATIONS_CLOSED: {
        LABEL: "Applications have closed for this semester; check back at the end of the semester!"
    }
}
...
export const FAQ = {
    ...
    JM_QUALITIES: {
        ...
        A: "We look for applicants who are dedicated to their students. This could be in the form " +
    ...
    JM_PREREQS: {
        ...
        A: "There are no formal requirements, but we prefer mentors who have had at least one " +
           "semester of academic interning, either in past semesters or concurrently."
    },
    JM_COMMITMENT: {
        Q: "What is the time commitment for a Junior Mentor?",
        A: "We estimate 3-4 hours/week, between a family meeting with Senior Mentors and other " +
    ...
    */
    JM_UNITS: {
        ...
        A: "Yes! Each Junior Mentor can receive 1 unit of P/NP credit. We will provide you the " +
    ...
    OTHER_TUTORING: {
        ...
        A: "Junior Mentors’ primary responsibility is to host group tutoring. However, Junior " +
    ...
    CS_370: {
        Q: "What is CS 370?",
        A: "CS 370, or CS 98, Introduction to Teaching Computer Science, is a class for aspiring " +
