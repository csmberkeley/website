...
export const COVER_SUBTITLE = "Computer Science Mentors for introductory electrical"
...
export const WHAT_IS_CSM = {
    LABEL: "What is CSM?",
    BODY: "CSM is a student-run organization that provides guidance and resources in a smaller" +
...
export const WHO_WE_ARE = {
    LABEL: "Who we are",
    BODY_JSX: ( // JSX is needed for bold formatting
        <p className="info">
...
export const LIKE_US_ON_FB = "Give our Facebook page a like for updates and events!";
