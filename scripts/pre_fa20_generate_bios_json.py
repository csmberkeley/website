...
"""
DEPRECATED:
This script was for the way bios were imported in every semester before Fall 2020, which is when the
section time and biography images got consolidated. Run the other script instead.
